...
{
	const PlayerData &plrData = getPlayerData();
	switch (attribute) {
	case CharacterAttribute::Strength:
...
void ModifyPlrMag(Player &player, int l)
{
	...
	int ms = l;
	ms *= player.getPlayerData().chrMana;
...
void ModifyPlrVit(Player &player, int l)
{
	...
	int ms = l;
	ms *= player.getPlayerData().chrLife;
...
void SetPlrMag(Player &player, int v)
{
	...
	int m = v;
	m *= player.getPlayerData().chrMana;
...
void SetPlrVit(Player &player, int v)
{
	...
	int hp = v;
	hp *= player.getPlayerData().chrLife;
